...
sub_data = 'New Person'   #This will create folders in datasets with the face of people, so change to your name after run this program.
...
webcam = cv2.VideoCapture(0) #'0' is use for your webcam.
